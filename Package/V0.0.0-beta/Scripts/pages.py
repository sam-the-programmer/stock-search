...
def title_func(title_name):
    ...
    logo.image('https://github.com/Password-Classified/Stock-Search/blob/master/Package/V0.0.0-beta/Images/logo.png', width=100)


# Pages
def welcome():
    st.image('https://github.com/Password-Classified/Stock-Search/blob/master/Package/V0.0.0-beta/Images/logo.png', width=520)
    st.write(f'''
# Stock Search
